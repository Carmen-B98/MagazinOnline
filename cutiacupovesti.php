    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
            <a href="scrisoareata.php" class="list-group-item">Scrisoarea ta</a>
            <a href="cadouri.php" class="list-group-item">Cadouri</a>
            <a href="cutiacupovesti.php" class="list-group-item">Cutia cu povești</a> 
        </div>
      </div>
      ...
      <?php
       //include connection file
        ...
        $sql='SELECT * FROM poze2;';
        $query=  mysqli_query($connect2, $sql)or die(mysqli_error($connect2));
        ?>
